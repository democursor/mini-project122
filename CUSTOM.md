...
|----------|-----------------|-----------------|---------------|--------------|
| Requirements | Himesh Yadav | Vedika Agarwal | Mentor | Team |
| Design | Himesh Yadav & Madhav Sharma | Himesh Yadav & Madhav Sharma | Mentor | Team |
| Implementation | Vedika Agarwal | Vedika Agarwal | — | Team |
| Testing | Madhav Sharma | Vedika Agarwal | Mentor | Team |
| Release | Madhav Sharma | Madhav Sharma | Mentor | Dept |

## 20. Team and Roles

| Member | Role | Responsibilities | Key skills | Availability | Contact |
|--------|------|------------------|------------|--------------|---------|
| Himesh Yadav | Product Lead | Scope, architecture, reviews | Python, AI/ML, APIs | 10 hrs/wk | himesh.yadav_cs.aiml23@gla.ac.in |
| Vedika Agarwal & Himesh Yadav | Tech Lead & Backend | Architecture, APIs, AI models | Python, FastAPI, Transformers, ChromaDB | 12 hrs/wk | vedika.agarwal_cs.aiml24@gla.ac.in |
| Vedika Agarwal & Madhav Sharma | Frontend | React UI, state, routing | React, JavaScript, Tailwind CSS | 10 hrs/wk | vedika.agarwal_cs.aiml24@gla.ac.in |

## 21. Week-wise Plan and Assignments

*(Schedule for Feb–Apr 2025; adjust to your calendar.)*

| Week | Dates | Milestones | Himesh (Lead) | Vedika (Backend) | Madhav (Frontend) | Vedika (QA/Docs) | Deliverables | Status |
|------|-------|------------|---------------|------------------|-------------------|------------------|--------------|--------|
| 1 | 1-7 Feb | Requirements freeze | Finalize scope | API contracts v0 | Wireframes | Test plan v0 | Draft SRS | Completed |
| 2 | 8-14 Feb | Architecture & DB | Arch review | PDF parsing & storage | UI kit | Test data | ERD, API spec v1 | Completed |
| 3 | 15-21 Feb | PDF Processing | Risks, unblock | PyMuPDF integration | Upload screens | Smoke tests | PDF module | Completed |
| 4 | 22-28 Feb | Chunking & Extraction | Sync | Semantic chunking + NER | Document list UI | Accessibility checks | Chunking module | Completed |
| 5 | 1-7 Mar | Embeddings & Vector DB | Cut scope | ChromaDB + Sentence-BERT | Search UI | CRUD tests | Vector search demo | Completed |
| 6 | 8-14 Mar | Knowledge Graph | KPIs | Neo4j integration | Graph visualization | Perf tests | Graph module | Completed |
| 7 | 15-21 Mar | RAG & AI Assistant | Feature review | LLM + RAG pipeline | Chat interface | Integration tests | AI chat demo | Completed |
| 8 | 22-28 Mar | Frontend Polish | UI/UX review | API optimization | Dashboard + styling | UI tests | Complete frontend | In Progress |
| 9 | 29 Mar-4 Apr | Testing & Bug Fixes | Bug triage | Backend fixes | Frontend fixes | Full regression | Bug-free build | Planned |
| 10 | 5-11 Apr | Documentation | Final review | API docs | User guide | Test reports | Complete docs | Planned |
| 11 | 12-18 Apr | Deployment & Demo | Demo prep | Deployment setup | Demo polish | Final QA | Live demo | Planned |
| 12 | 19-25 Apr | Final Submission | Sign-off | Code cleanup | Final touches | Documentation review | Project submission | Planned |


## 22. Detailed System Architecture Diagram
...
- Pages: Dashboard, Upload, Documents, Search, Chat, Knowledge Graph
